...
class CornersProblem(search.SearchProblem):
    ...
    def isGoalState(self, state):
        ...
        return corners == (pos,) # true if pos is the last corner
    ...
    def getSuccessors(self, state):
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if(not hitsWall):
                ...
                successor = ((nextPosition, cornersLeft), action, 1)
...
def cornersHeuristic(state, problem):
    ...
    "*** YOUR CODE HERE ***"
    # Optimal distance is the distance without walls impeding movement. Should be the optimal distance,
